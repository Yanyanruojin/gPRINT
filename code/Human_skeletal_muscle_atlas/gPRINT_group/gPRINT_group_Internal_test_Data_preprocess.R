...
write.csv(train.markers,'./cnn_12vs17/marker/train_marker.csv')
write.csv(test.markers,'./cnn_12vs17/marker/test_marker.csv')
...
path_out_rf= paste0('/data/yrj/MTJ/人类骨骼肌图谱/cnn_12vs17/marker/train_marker2_all.csv')

path_out_query= paste0('/data/yrj/MTJ/人类骨骼肌图谱/cnn_12vs17/marker/test_marker2_all.csv')
