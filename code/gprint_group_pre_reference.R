### gprint_group_pre_reference.R $1 $2
### gprint_group_pre_reference.R human_Pancreas349 Pancreas
...
pathe_gene = paste0(path_main,args[2],'/model/group_level/order_markergenes_reference.csv')
...
path_out_query= paste0(path_main,args[2],'/query/',args[1],'_group_query_all.csv')
